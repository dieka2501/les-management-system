...
- Manajemen cabang, mata pelajaran, data keluarga murid, guru, dan jadwal.
...
Dashboard admin mencakup manajemen cabang, mata pelajaran, data keluarga murid, guru, jadwal manual, dan generator jadwal otomatis. Data operasional memakai `branch_id`, bukan teks kota bebas. Cabang menyimpan nama, alamat, dan kota/kabupaten, misalnya:
